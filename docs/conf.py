...
# -*- coding: utf-8 -*-
#
# bs_dateutil documentation build configuration file, created by
...
from bs_dateutil import __version__ as VERSION  # Explicitly use a relative path
...
htmlhelp_basename = "bs_dateutildoc"
...
latex_documents = [
    ("index", "bs_dateutil.tex", "bs_dateutil Documentation", "bs_dateutil", "manual"),
]
...
man_pages = [("index", "bs_dateutil", "bs_dateutil Documentation", ["bs_dateutil"], 1)]
