    ...
    **Examples:**
    ...
    .. versionchanged:: 2.7.0
        ...
        .. doctest::
            ...
            >>> from bs_dateutil.tz import tzutc, UTC
            >>> tzutc() is tzutc()
            True
            >>> tzutc() is UTC
            True
...
class tzfile(_tzinfo):
    ...
    .. note::
        ...
        :func:`bs_dateutil.tz.gettz` with the zone identifier.
...
class tzstr(tzrange):
    ...
    def __init__(self, s, posix_offset=False):
        global parser
        from bs_dateutil.parser import _parser as parser
...
def __get_gettz():
    ...
    class GettzFunc(object):
        ...
        :return:
            Returns an instance of one of ``bs_dateutil``'s :py:class:`tzinfo`
            subclasses.
            ...
            if name is None or name in ("", ":"):
                ...
                if os.path.isabs(name):
                    ...
                    for path in TZPATHS:
                        ...
                        if not tz:
                            from bs_dateutil.zoneinfo import get_zonefile_instance
