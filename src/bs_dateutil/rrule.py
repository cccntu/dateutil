...
class rrule(rrulebase):
    ...
    .. note::
        ...
        >>> from bs_dateutil.rrule import rrule, MONTHLY
    ...
    :param count:
        ...
        .. note::
            ...
            with ``count`` is deprecated, to make sure ``bs_dateutil`` is fully
    ...
    def __init__(
        ...
        if count is not None and until:
            warn(
                ...
                " and has been deprecated in bs_dateutil. Future versions will "
                "raise an error.",
                DeprecationWarning,
            )
    ...
    def __str__(self):
        ...
        bs_dateutil-specific extension BYEASTER.
        """
...
class _rrulestr(object):
    ...
    :param forceset:
        If set ``True`` forces a :class:`bs_dateutil.rrule.rruleset` to
        be returned.
    ...
    :param tzids:
        ...
        Defaults to :func:`bs_dateutil.tz.gettz`.

    :param tzinfos:
        Additional time zone names / aliases which may be present in a string
        representation.  See :func:`bs_dateutil.parser.parse` for more
        information.

    :return:
        Returns a :class:`bs_dateutil.rrule.rruleset` or
        :class:`bs_dateutil.rrule.rrule`
    """
