...
# bs_dateutil imports
from bs_dateutil.relativedelta import relativedelta, SU, TH
from bs_dateutil.parser import parse
from bs_dateutil import tz as tz
...
MISSING_TARBALL = (
    "This test fails if you don't have the bs_dateutil "
...
class TzUTCTest(unittest.TestCase):
    ...
    def testTimeOnlyUTC(self):
        # https://github.com/bs_dateutil/bs_dateutil/issues/132
        # tzutc doesn't care
        tz_utc = tz.tzutc()
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            marks=[
                pytest.mark.skipif(PY2, reason="bytes arguments accepted in Python 2")
            ],
        ),
        pytest.param(
            object(),
...
def test_valid_bs_dateutil_format(tz_str, expected):
    # This tests the bs_dateutil-specific format that is used widely in the tests
...
class TzWinTest(unittest.TestCase, TzWinFoldMixin):
    ...
    def testTzwinName(self):
        # https://github.com/bs_dateutil/bs_dateutil/issues/143
    ...
    def testTzWinEquality(self):
        # https://github.com/bs_dateutil/bs_dateutil/issues/151
        tzwin_names = (
...
class TzWinLocalTest(unittest.TestCase, TzWinFoldMixin):
    ...
    def testLocal(self):
        ...
        # See GitHub Issue #135: https://github.com/bs_dateutil/bs_dateutil/issues/135
