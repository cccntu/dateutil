...
from bs_dateutil.parser import ParserError
from bs_dateutil.parser import UnknownTimezoneWarning
...
class ParserTest(unittest.TestCase):
    ...
    def testCustomParserInfo(self):
        ...
        from bs_dateutil.parser import parserinfo, parser
    ...
    def testCustomParserShortDaynames(self):
        ...
        # https://github.com/bs_dateutil/bs_dateutil/issues/343
        from bs_dateutil.parser import parserinfo, parser
...
class TestParseUnimplementedCases(object):
    ...
    def test_extraneous_numerical_content(self):
        # ref: https://github.com/bs_dateutil/bs_dateutil/issues/1029
